...
export default {
  ...
  theme: {
    extend: {
      // Custom Colors - Modern Professional Palette
      colors: {
      ...
      boxShadow: {
        ...
        'elevated': '0 12px 28px -8px rgb(0 0 0 / 0.12), 0 6px 12px -6px rgb(0 0 0 / 0.06)',
        'dialog': '0 24px 48px -12px rgb(0 0 0 / 0.18), 0 12px 24px -8px rgb(0 0 0 / 0.1)',
      },
      // Border Radius
      borderRadius: {
        'sm': '0.25rem',
      ...
      // Ring colors - extend from main colors
      ringColor: {
        primary: {
          400: '#818CF8',
          500: '#6366F1',
